...
class ProspectiveClientResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Prospective Clients';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('is_client')->formatStateUsing(fn (bool $state): string => $state ? 'Client' : 'Prospective Client'),
            ])
            ->filters([
                //
            ])
